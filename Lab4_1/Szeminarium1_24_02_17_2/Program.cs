...
namespace zsim2317_lab4_1
{
    internal static class Program
    {
        ...
        private static GlObject magnolia;

        private static string objName = "Szeminarium1_24_02_17_2.Resources.magnolia.obj";
        ...
        private static unsafe void Drawmagnolia()
        {
            // set material uniform to rubber

            var modelMatrixForMagnolia = Matrix4X4.CreateScale(1f, 1f, 1f);
            SetModelMatrix(modelMatrixForMagnolia);
            Gl.BindVertexArray(magnolia.Vao);
            Gl.DrawElements(GLEnum.Triangles, magnolia.IndexArrayLength, GLEnum.UnsignedInt, null);
            Gl.BindVertexArray(0);
        }
        ...
        private static unsafe void SetUpObjects()
        {
            ...
            magnolia = ObjResourceReader.Create3DObjectWithColor(Gl, face1Color, objName);
