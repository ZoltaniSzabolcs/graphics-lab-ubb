...
namespace Szeminarium1_24_02_17_2
{
    internal static class Program
    {
        ...
        private static unsafe void Window_Render(double deltaTime)
        {
            ...
            DrawBinNormalPerpendicular(new Vector3D<float>(0f, 2f, 0f));

            DrawBinNormalCalculatedInXZ(new Vector3D<float>(0f, -2f, 0f));

        }

        private static unsafe void DrawBinNormalPerpendicular(Vector3D<float> location)
        {
            ...
            // Placing clockwise the rectangles
            ...
            for (int i = 0; i < 18; i++)
            {
                ...
                Gl.BindVertexArray(glRectanglesUp[i].Vao);
                Gl.DrawElements(GLEnum.Triangles, glRectanglesUp[i].IndexArrayLength, GLEnum.UnsignedInt, null);
                Gl.BindVertexArray(0);
            }
        }

        private static unsafe void DrawBinNormalCalculatedInXZ(Vector3D<float> location)
        {
            Matrix4X4<float> scale = Matrix4X4.CreateScale(1.0f);
            ...
            for (int i = 0; i < 18; i++)
            {
                ...
                Matrix4X4<float> modelMatrix = translation * rotationMatrix * Matrix4X4.CreateTranslation(location);
                SetModelMatrix(modelMatrix);
                Gl.BindVertexArray(glRectanglesDown[i].Vao);
                Gl.DrawElements(GLEnum.Triangles, glRectanglesDown[i].IndexArrayLength, GLEnum.UnsignedInt, null);
                Gl.BindVertexArray(0);
            }
        }
        ...
        {
            float[] color = [0.42f, 0.42f, 1.0f, 1.0f];
